  ...
  useEffect(() => {
    async function getStars() {
      const repos = await fetch(
        'https://api.github.com/users/ibrahim-sec/repos?per_page=100'
      )
              ...
              <div className="card" key={project.slug}>
                <div className="stars">
                  {repos.find((repo) => repo.name === project.slug) && (
                    <div className="star">
                      <a
                        href={`https://github.com/ibrahim-sec/${project.slug}/stargazers`}
                      >
                        {Number(
                          repos.find((repo) => repo.name === project.slug)
                            .stargazers_count
                ...
                <a
                  ...
                  href={`https://github.com/ibrahim-sec/${project.slug}`}
                  target="_blank"
                  rel="noreferrer"
                >
                  {project.name}
